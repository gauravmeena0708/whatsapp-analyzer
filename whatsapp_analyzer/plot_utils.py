...
def plot_most_active_hours(df, username=None):
    ...
    plt.figure(figsize=(12, 6), constrained_layout=True)
    if message_counts_by_hour.empty:
        plt.text(0.5, 0.5, "No activity data to plot.", ha='center', va='center', fontsize=12)
...
def analyze_sentiment_over_time(df, username=None):
    ...
    if daily_sentiment.empty:
        plt.text(0.5, 0.5, "No sentiment data over time to plot.", ha='center', va='center', fontsize=12)

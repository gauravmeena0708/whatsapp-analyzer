...
def create_plotly_chart_section(analyzer):
    ...
    chart_filename = os.path.abspath("./data/plotly_chart.png")  # Absolute path for PNG
    fig.write_image(chart_filename, width=800, height=400, scale=2)  # Adjust size and scale
    
    return {
        "type": "image",
        "data": chart_filename,  # Reference the PNG file
        "width": 800,  # Set the desired display width
        "height": 400  # Set the desired display height
    }
    ...
    try:
        ...
        content = [
            ...
            *create_top_5_emojis_section(analyzer)#,
            #create_plotly_chart_section(analyzer),  # Updated function call
        ]
